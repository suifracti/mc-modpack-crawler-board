...
export const CURSEFORGE_COVER_FALLBACK = 'data:image/svg+xml;charset=utf-8,%3Csvg xmlns%3D"http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg" width%3D"400" height%3D"225" viewBox%3D"0 0 400 225"%3E%3Crect width%3D"400" height%3D"225" fill%3D"%231c1917"%2F%3E%3Ctext x%3D"50%25" y%3D"50%25" dominant-baseline%3D"middle" text-anchor%3D"middle" fill%3D"%23f16436" font-family%3D"sans-serif" font-size%3D"14"%3ECurseForge 暂无封面%3C%2Ftext%3E%3C%2Fsvg%3E';
...
export function renderCurseforgeCard(p: CurseforgePack): string {
  ...
  const coverImg = p.icon_url || CURSEFORGE_COVER_FALLBACK;
  ...
  return '<div class="curseforge-pack-card">' +
    ...
    '<img class="xyebbs-card-img" src="' + escHtml(coverImg) + '" alt="' + safeTitle + '" loading="lazy" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src=window.CURSEFORGE_COVER_FALLBACK;">' +
